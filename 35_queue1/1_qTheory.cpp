...
// enqueue   dequeue  isEmpty  isFull   front(element which comes first)   size

// types of queue:
// 1. simple queue-> time ke base pe hi criteria hai, matlab jo sabse pehle aaya wo sabse pehle nikalega bhi..
...
// 4. doubly ended queue-> element front aur rear dono jagah se insert aur delete kiya ja sakta hai..
...
-> underflow when q is empty and you are trying to access something
