...
public:
    ...
    int solve(TreeNode* root){
        if (root == NULL) return 0; // binary tree mai nalla case na likha to kya likha..
    ...
    int maxPathSum(TreeNode* root) {
        maxSum = INT_MIN;
        solve(root);    // maxSum ko globally initialise kar diya ab dekh kahi bhi paas nahi kar rha...
        return maxSum;
    }
