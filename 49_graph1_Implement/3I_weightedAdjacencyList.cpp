...
using namespace std;
 ...
 // globally banaya taki fn call me pass na karna pade
vector < list <pair<int,int> > > graph;     

// or vector <vector <pair <int, int>>> graph;
...
void display(){
    ...
    for (int i=0; i<graph.size(); i++){
        ...
        // for (auto &[nbr, wt] : adj[node]) cout<<nbr<<wt<<endl;
