...
Oops -> scalability code efficient 
we use classes and object
oop is used widely in real world programming
...
access modifiers :-> Public -> bahar se koi bhi access kar sakta hai...
