...
public:
    string maximumOddBinaryNumber(string s){
        ...
        string ans;
        // append n-1 ones at beginning then append all zeroes then finally 1 at end...
...
// for odd -> keep single 1 at end and for remaining oneCount add them in very beginning...(laalchi approach)