...
public:
    ...
    int findContentChildren(vector<int>& g, vector<int>& c) {
        ...
        // har greed ke liye dekha kya mere paas koi cookie hai..jo need satisfy kar de...
        // jis bhi cookie ne need satisfy kari now uske next wali cookie se second wali greed check karo....
