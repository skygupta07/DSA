...
// loop se bahar aaya condition break karwa ke...to simply aapka i yahi hoga..
    if(i==a.size()){
        while (j<b.size()){
            res[k]=b[j];
            k++;
...
1. agar vector mai push_back karna hai ginti ke element to size mat mention karo....
