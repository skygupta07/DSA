// findTheMaximumSumOfNodeValue.cpp
...
You are also given a positive integer k, and a 0-indexed array of non-negative integers nums 
of length n, where nums[i] represents the value of the node numbered i.
...
if there are even number of guys on which if i perform xor operation 
then their value increases is a simple case...
